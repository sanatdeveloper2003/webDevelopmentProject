...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. Messina">
            </div>
            <div class="inputBox">
                <span>province :</span>
                <input type="text" name="state" placeholder="e.g. Messina">
            </div>
            <div class="inputBox">
                <span>country :</span>
                <input type="text" name="country" placeholder="e.g. Italy">
            </div>
            <div class="inputBox">
                <span>tax Code :</span>
                <input type="number" min="0" name="pin_code" placeholder="e.g. 98166">
            </div>
        </div>
